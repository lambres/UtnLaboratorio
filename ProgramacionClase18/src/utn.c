...
/// @fn int getDni(char*, int)
/// @brief Obtiene un string calido como DNI
///
/// @pre
/// @post
/// @param pResultado Puntero al espacio de memoria donde se almacenara el resultado
/// @param longitud tamaño del puntero
/// @return Devuelve 0 EXITO si se obtiene un DNI valido y -1 si ERROR
static int getDni(char* pResultado, int longitud)
{
	int retorno = -1;
	char buffer[4096];
...
/// @fn int utn_getDni(char*, int, char*, char*, int)
/// @brief  Solicita un DNI al USUARIO, luego de verificarlo devulelve el resultado
///
/// @pre
/// @post
/// @param pResultado Puntero al espacio de memoria donde se dejara el resultado de la funcion
/// @param longitud es la longitud del array resultado
/// @param mensaje Es el mensja a mostrar
/// @param mensajeError Si hay error muestra este mensaje
/// @param reintentos Cantidad de reintentos en caso de error
/// @return Devuleve 0 EXITO si se obtuvo u DNI Valido y -1 se ERROR
